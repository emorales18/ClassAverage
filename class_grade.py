...
""" PLAIN ENGLISH
start
creat a list to store 5 number (float)
capture user's inout 5 times for their grades
...
once we have three highest number in the list, we sum them up and divide them by 3
outout a message to the user
end
"""
